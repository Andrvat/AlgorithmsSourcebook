...
- Структуры данных
    ...
    - [Стек. Преобразование инфиксной записи в постфиксную. Вычисление значения выражения.](#Стек-в-применении.-Вычисление-значения-выражения)
...
## Стек в применении. Вычисление значения выражения
