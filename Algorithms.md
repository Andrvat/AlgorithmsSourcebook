...
Дадим сначала некоторые определения, чтобы бы с вами говорили на одном языке. **Алфавитом** называется конечное множество символов, а **сообщением** называется конечная последовательность символов. Множество всех сообщений алфавита _А_ будем обозначать за _А*_.
