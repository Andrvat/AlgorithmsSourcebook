...
Далее, просеивание имеет логарифмическую сложность. Это так, потому что мы в основном теле прошлись по всем элементам массива, применив к нему *heapfy()*, имеющую логарифмическую зависимость, и *swap()*, работающий за константное время - итого имеем *n * log2(n)*.
