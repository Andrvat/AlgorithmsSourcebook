...
```
Можно условиться, что функция будет возвращать -1 в качестве _false_ и индекс найденного элемента в списке в противном случае - как один из вариантов улучшения метода. Возможно будет выгоднее вернуть сам узел, чтобы вне функции можно было с ним работать.
